    ...
    <div class="container down">
        <div class="row">
            <div class="col-sm-4 col-md-6 col-md-offset-3">
                <h1 class="text-center login-title">Sign in to EverGreen Solar Dashboard</h1>
                <div class="account-wall">
                    ...
                    <div class="form-signin">
                        ...
                        <div class="form-group">
                            <?php echo form_input(['class' => 'form-control', 'name' => 'username', 'placeholder' => 'Username or email', 'required' => 'required']); ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            $options = array(
                                ...
                                'logestic'   => 'Logestics Team',
                                'projectEngineer'   => 'Project Engineer',
                                'siteEngineer'   => 'Site Engineer'
                            );
                            $css = array('class' => 'form-control');
                            echo form_dropdown('role', $options, 'SelectRole', $css);
                    ...
                    <option value="Agent">Agent</option>
                        ...
                        <?php echo form_submit(['class' => 'btn btn-lg btn-primary btn-block', 'type' => 'submit', 'value' => 'Sign in']); ?>
                        <!-- </form> -->
                        <div class="mt-5 ml-4">
                            <h4>Don't have an account ! <a href="<?= base_url('Register'); ?>">Sign-up</a></h4>
                        </div>
                    </div>
                </div>
            </div>
