   ...
   <nav class="navbar navbar-expand navbar-white navbar-light">
     ...
     <ul class="navbar-nav">
       ...
       <li class="nav-item d-none d-sm-inline-block ">
         <a href="<?php echo site_url('Return-Dashboard'); ?>" class="btn btn-success">Dashboard</a>
       </li>
     </ul>
   </nav>
     ...
     <div class="modal-dialog modal-lg">
       <div class="modal-content">
         ...
         <div class="modal-body">
           <?php echo form_open('PaymentTerm-Edit-Action'); ?>
         ...
         <div class="col-md-12">
           <div class="card card-info mt-3">
             <div class="card-header">
               ...
               <?php } ?>
               <?php if ($error = $this->session->flashdata('paymentFail')) { ?>
                 <div class="row">
           ...
           <div class="card-body">
             <table class="table ">
                  ...
                  if ($this->cart->total_items() > 0) {
                    foreach ($this->cart->contents() as $value) { ?>
                     <tr>
                       ...
                       <td><a href="<?php echo site_url('Agent/editremoveitem/' . $value["rowid"]); ?>" class="btn btn-danger" onclick="return confirm('Are you Sure')">Cancle</a></td>
               ...
               <tfoot>
                 <tr>
                   <td colspan="2"><a href="<?php echo site_url('Agent/editaddqouproduct'); ?>" class="btn btn-warning"><strong> Add Product</strong></a></td>
                   <?php echo form_open("Agent/updatecommission"); ?>
                   <td colspan="2">Extra Commission :<?php echo form_input(['type' => 'number', 'name' => 'comm', 'value' => '0']); ?><?php echo form_submit(['class' => 'btn btn-primary', 'type' => 'submit', 'value' => 'Update']); ?></td>
                   </form>
                   <?php
                   ...
                   <td><a href="<?php echo site_url('Agent/updatecommission'); ?>" class="btn btn-success float-right"><strong> Continue To Quotation</strong></a></td>
                 </tr>
               </tfoot>
             </table>
           </div>
