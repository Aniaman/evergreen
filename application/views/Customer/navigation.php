  ...
  <div class="left-sidenav">
    ...
    <div class="menu-content h-100 mt-5" data-simplebar>
      <ul class="metismenu left-sidenav-menu">
        <li>
          <a href="<?= base_url('Customer-DashBoard') ?>"><i data-feather="home" class="align-self-center menu-icon"></i><span>Dashboard</span></a>
        </li>
      </ul>
    </div>
  </div>
        ...
        <ul class="list-unstyled topbar-nav float-end mb-0">
          ...
          <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <a class="dropdown-item" href="<?= base_url('Logout-customer') ?>"><i data-feather="power" class="align-self-center icon-xs icon-dual me-1"></i> Logout</a>
            </div>
          </li>
        </ul>
